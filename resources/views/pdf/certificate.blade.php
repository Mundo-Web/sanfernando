    ...
    <style>
        * {
        ...
        .container-row{
          ...
          width: 1000px;
          min-height: 100vh; 
          page-break-inside: avoid; /* Evitar quiebre de página */
        ...
        height:100%;
        display: inline;
        vertical-align: top; /* Alinear al inicio si hay problemas de altura */
        page-break-inside: avoid; /* Evitar quiebre de página */
        }
            ...
            <div class="image-container">
                    ...
                    <tbody>
                        <tr>
                            <td align="left" style="vertical-align: middle">
                                <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/72318f99933ec24f075e143dfcf0d49da68332f7946bcaabdec7f2c94e46db8a?placeholderIfAbsent=true&apiKey=0f2111aa112942eda6dda1d2ced51822"
                ...
                <div class="text-container">
                    <h4 class="title" style="text-transform: uppercase">DIPLOMADO EN
                        {{ $attemp->evaluation->course->producto }}
                    </h4>
                    <p class="description">En mérito a su participación en nuestro <span class="bold-italic"
                            ...
                            {{ $attemp->evaluation->course->producto }}.</span> Organizado por <b>EGESPP</b>, con una
                        duración de
            ...
            <section class="signature-section">
                        ...
                        <tr>
                            <td align="center" style="padding: 0 40px">
                                <p class="signature-name"
                                    style="margin: 0; border-top: 1px solid #333; padding-top: 10px">Patricia
                                    Heredia Olivera</p>
                                <p class="signature-title" style="margin: 0">Gerente General</p>
                            </td>
                            <td align="center" style="padding: 0 40px">
                                <p class="signature-name"
                                    style="margin: 0; border-top: 1px solid #333; padding-top: 10px">Edwin Chichipe
                                    Salazar</p>
             ...
             <section class="agreements-section" style="margin-top: 10px">
                    ...
                    <div class="agreements-logos">
                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/2e035b51907acddd8242408a9668baf54b544831e1aab26c57344b33ee99cfa8?placeholderIfAbsent=true&apiKey=0f2111aa112942eda6dda1d2ced51822"
                            alt="Convenio Logo 1" class="agreements-logo" loading="lazy" />
                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/cbcff7432f010eec9ed530d9243dffda70b428a0940a30a17632b7fa756a47fe?placeholderIfAbsent=true&apiKey=0f2111aa112942eda6dda1d2ced51822"
                            alt="Convenio Logo 2" class="agreements-logo" loading="lazy" />
                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/29505368281a22ff9bf6d085f2e30040108fbe8d3c3cc2819e4404a9987a47d9?placeholderIfAbsent=true&apiKey=0f2111aa112942eda6dda1d2ced51822"
