  ...
  <main class="z-[15] ">
      ...
      <div class="swiper slider">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div
              class="gap-20 bg-no-repeat object-top  bg-center bg-cover w-full px-[5%] h-[600px] xl:h-[650px] flex flex-row  items-center"
              ...
              <div class="flex flex-row justify-center items-center gap-2 w-full md:w-2/3 py-12 lg:py-24">
                <div class="flex flex-col gap-5 lg:gap-10 items-start px-0 lg:px-[2%]">
                  <h2 class='text-white text-3xl lg:text-6xl tracking-normal font-poppins_black font-bold uppercase'>
    ...
    <section>
      <div class="grid grid-cols-1 lg:grid-cols-2 w-full gap-12 px-[8%] py-12 xl:py-16">
        ...
        <div class="flex flex-col justify-center items-center">
          <img src="{{ asset('images/img/gp_nosotros.png') }}" class="object-contain h-[300px] md:h-[500px] w-full" />
        </div>
      </div>
    </section>
        ...
        <div class="flex relative flex-col flex-1 shrink basis-0 min-w-[240px]">
          ...
          <div
            ...
            <div
              ...
              <span class="gap-2.5 self-stretch px-1.5 py-1 my-auto bg-red-800 rounded font-poppins_regular">CURSO</span>
            </div>
            ...
            <div
              ...
              <div class="flex flex-row gap-2 items-start justify-start">
                <img loading="lazy" src="{{ asset('images/svg/gp_reloj.svg') }}" class="object-contain w-6"
                  alt="Clock icon" />
                <p class="self-stretch leading-normal">384 horas lectivas y 24 créditos</p>
              </div>
              <div class="flex gap-2 items-center self-start mt-2">
                <img loading="lazy" src="{{ asset('images/svg/gp_calendario.svg') }}" class="object-contain w-6 "
                  alt="Calendar icon" />
    ...
    <section class="px-[8%] bg-cover" style="background-image: url({{ asset('images/img/palacio.png') }})">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 w-full gap-12 pt-12 pb-12 xl:pb-16">
        <div class="flex flex-col px-5 pt-5 pb-20 w-full rounded-xl border border-gray-50 border-solid min-h-[236px]">
    ...
    <section
      ...
      <div
        ...
        <nav
          ...
          <a href="#" class="gap-3 self-stretch px-6 py-3 rounded-xl bg-slate-900 min-w-[240px] max-md:px-5">
            Explorar todos los cursos y Diplomados
          </a>
        </nav>
      </div>
      <div class="flex flex-wrap gap-10 items-center self-stretch my-auto text-white min-w-[240px] max-md:max-w-full">
    ...
    <section>
      <div class="grid grid-cols-1 xl:grid-cols-2 w-full gap-12 px-[8%] py-12 xl:py-16">
        ...
        <div class="flex flex-col justify-center items-center px-0 lg:px-[5%]">
          <div
            class="w-full h-[500px] lg:h-[700px] border border-gray-200 rounded-3xl overflow-hidden relative bg-cover bg-center"
              ...
              <div class="flex flex-col w-6/12 max-md:w-full">
                <div class="flex flex-col justify-center self-stretch w-full max-md:mt-10 gap-3">
                  <div class="flex flex-col max-w-full text-white w-[377px]">
                    <h1 class="text-5xl !font-poppins_regular font-bold leading-snug">
                      Se parte del Cambio
                    </h1>
            ...
            <ol class="flex flex-col self-end mt-10 w-full max-w-[417px] list-none">
              <li class="flex gap-5 items-start w-full">
                ...
                <div class="flex flex-col flex-1 shrink justify-center basis-0 !text-base">
                  ...
                  <p class="mt-3 text-base tracking-normal leading-loose text-white !font-poppins_regular">
                    Crea y edita tu perfil
                  </p>
                </div>
              </li>
              <li class="flex gap-5 items-center mt-6 w-full">
                <div class="flex flex-col flex-1 shrink justify-center self-stretch my-auto basis-0 !text-base">
                  <span
