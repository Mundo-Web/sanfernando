<x-app-layout>
  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    <form action="{{ route('politicadatos.act', $politicas->id) }}" method="POST">
      @csrf
      @method('POST')
      <div
            ...
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  ...
                  {{-- <x-textarea id="description" name="content" :value="$politicas->content" /> --}}
                  <x-form.quill id="content" name="content" :value="$politicas->content" />
                  {{--  <textarea  id="description" name="content"
                                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="content">{{ $politicas->content }}</textarea> --}}
                </div>
              </div>
