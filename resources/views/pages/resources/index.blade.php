  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div
      ...
      <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
        <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Recursos</h2>
      </header>
      <div class="p-3">
          ...
          <table id="tabladatos" class="display text-lg" style="width:100%">
            ...
            <tbody>
              ...
              @foreach ($staff as $item)
                <tr>
                  <td>{{ $item->name }}</td>
                  <td><img src="{{ asset($item->imagen) }}" id="imagen1"
                    class="w-20 max-h-48 object-contain "></td>
                  <td>
...
<script>
  $('document').ready(function() {
    ...
    $(".btn_swithc").on("change", function() {
      ...
      $.ajax({
        url: "{{ route('resources.updateVisible') }}",
        method: 'POST',
        data: {
    ...
    $(".btn_delete").on("click", function(e) {
        ...
        Swal.fire({
          ...
          text: "Vas a eliminar un recurso",
          icon: "warning",
