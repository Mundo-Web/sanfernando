<x-app-layout>
  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    <form action="{{ route('resources.update', $staff->id) }}" method="POST" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div
          ...
          <div class="rounded shadow-lg p-4 px-4 ">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2 mt-2">
                  <img src="{{ asset($staff->imagen) }}" id="imagen1"
              ...
              <div class="md:col-span-5">
                ...
                <div class="relative mb-2  mt-2">
                  <select name="tags[]" id="tags" class="select2 w-full" multiple="multiple">
                    @foreach ($etiquetasall as $item) <!-- Ahora estamos usando las etiquetas únicas -->
                        <option value="{{ $item->name }}" {{ in_array($item->id, $etiquetas) ? 'selected' : '' }}>
                            {{ $item->name }}
                        </option>
                    @endforeach
                  </select>
