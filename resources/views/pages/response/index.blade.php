  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div
      ...
      <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
        <h2 class="font-semibold text-slate-800 dark:text-slate-100 text-2xl tracking-tight">Respuestas</h2>
      </header>
      <div class="p-3">
          ...
          <table id="tabladatos" class="display text-lg" style="width:100%">
            ...
            <tbody>
              ...
              @foreach ($response as $item)
                <tr>
                  <td class="">{{ $item->response }}</td>
                  <td class="">{{ $item->questions->question }}</td>
                  ...
                  <td class="flex flex-row justify-end items-center gap-5 ">
                    ...
                    <a href="{{ route('response.edit', $item->id) }}"
    ...
    $('document').ready(function() {
      ...
      $(".btn_delete").on("click", function(e) {
        ...
        Swal.fire({
          ...
          text: "Vas a eliminar una respuesta",
          icon: "warning",
          ...
          if (result.isConfirmed) {
            ...
            $.ajax({
              ...
              url: '{{ route('response.deleteResponseExam') }}',
              method: 'POST',
              data: {
      ...
      $(".btn_swithc").on("change", function() {
        ...
        $.ajax({
          url: "{{ route('response.updateVisible') }}",
          method: 'POST',
          data: {
            _token: $('input[name="_token"]').val(),
            status: status,
