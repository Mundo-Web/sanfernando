  ...
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="grid grid-cols-5">
      <div class="md:col-span-2">
        <label for="ocupation">UrlVideo</label>
        <div class="relative mb-2  mt-2">
          ...
          <input type="text" id="url_testimonios" name="url_testimonios" value="{{ $general->url_testimonios }}"
            class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
      ...
      <div class="col-span-2 flex items-center">
        <button type="button" id='saveUrl'
          class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 mt-5 ml-2
          px-4 rounded">Guardar
          url</button>
      </div>
    </div>
  ...
  <script>
    $('document').ready(function() {
      ...
      $("#saveUrl").on("click", function() {
        ...
        let urlval = $('#url_testimonios').val();

        $.ajax({
          url: "{{ route('testimonios.updateurl') }}",
          method: 'POST',
          data: {
            _token: $('input[name="_token"]').val(),
            url: urlval
          ...
          Swal.fire({
            position: "top-end",
            icon: "success",
            title: "Url de testimonios actualizado",
            showConfirmButton: false,
            timer: 1500
