...
<div className="flex relative flex-col flex-1 shrink basis-0 min-w-[240px]">
    <div className="min-w-[240px]">
        <img loading="lazy" src={`${imgcurso}`}  className="object-contain z-0 w-full rounded-t-2xl"
    ...
    <div className="flex z-0 flex-col p-6 w-full bg-white border-r border-l border-rose-100 border-opacity-40 max-md:px-5">
        <div
            ...
            <span className="gap-2.5 self-stretch px-1.5 py-1 my-auto bg-red-800 rounded font-poppins_regular">CURSO</span>
        </div>
        <h2 className="mt-4 text-2xl font-semibold font-poppins_medium leading-7 text-neutral-800">Políticas
            Públicas en Perú</h2>
        <div
            ...
            <div className="flex flex-row gap-2 items-start justify-start">
                <img loading="lazy" src={`${imgreloj}`}  className="object-contain w-6"
                    alt="Clock icon" />
                <p>384 horas lectivas y 24 créditos</p>
            </div>
