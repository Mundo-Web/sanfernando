                            ...
                            <div className="flex relative flex-col w-full aspect-square">
                                <div className="flex relative flex-col  w-full aspect-square max-md:pt-24">
                                    <img loading="lazy"
                                        ...
                                        className="object-cover absolute inset-0 size-full" alt="Profile picture" />
                                    <div
                                        className="flex relative gap-2 justify-center items-end p-3 bg-black bg-opacity-50">

                                        <label for="file-upload" className="self-stretch my-auto cursor-pointer">Subir foto
                                            <input classNameName='hidden' id="file-upload" type='file' /></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <form className="flex flex-col w-full max-md:max-w-full">
                    <div className="flex flex-wrap gap-5 justify-center items-end w-full max-md:max-w-full">
                        <div className="flex overflow-hidden flex-col flex-1 shrink basis-9 min-h-[76px] min-w-[240px]">
                            <label for="fullName" className="text-sm tracking-normal leading-loose">Nombre completo</label>
                    ...
                    <div className="flex overflow-hidden flex-col mt-5 w-full min-h-[76px] max-md:max-w-full">
                        <label for="username" className="text-sm tracking-normal leading-loose">Nombre de usuario</label>
                        <input type="text" id="username"
                            className="w-full py-3 px-3 focus:outline-none text-[#CF072C] placeholder-[#CF072C] focus:placeholder-[#CF072C] font-normal text-base bg-[#FFF0F0] rounded-xl border-2 border-transparent focus:border-2 focus:border-[#CF072C] focus:ring-0"
                            placeholder="Nombre de usuario" />
                    </div>
                    <div
                        className="flex overflow-hidden flex-col mt-5 w-full whitespace-nowrap min-h-[76px] max-md:max-w-full">
                        <label for="email" className="text-sm tracking-normal leading-loose">Email</label>
                    ...
                    <div
                        className="flex overflow-hidden flex-col mt-5 w-full whitespace-nowrap min-h-[76px] max-md:max-w-full">
                        <label for="occupation" className="text-sm tracking-normal leading-loose">Ocupación</label>
                        <input type="text" id="occupation"
                            className="w-full py-3 px-3 focus:outline-none text-[#CF072C] placeholder-[#CF072C] focus:placeholder-[#CF072C] font-normal text-base bg-[#FFF0F0] rounded-xl border-2 border-transparent focus:border-2 focus:border-[#CF072C] focus:ring-0"
                            placeholder="Estudiante" />
                    </div>
                    <button
                    className="gap-2.5 self-stretch px-5 py-2.5 mt-6 w-full text-sm font-semibold text-center text-teal-50 bg-rose-700 rounded-lg min-h-[40px]">Salvar
                    cambios</button>
                </form>
            </div>
        </div>
