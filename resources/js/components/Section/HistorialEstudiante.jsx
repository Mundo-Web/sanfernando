...
<div className="flex flex-col">
    <div
        ...
        <div className="flex flex-col self-stretch my-auto min-w-[240px]">
            <time datetime="2024-04-01T11:30:00" className="text-lg tracking-tight leading-none text-neutral-800">
            ...
            <div className="flex gap-4 items-start mt-3 text-sm tracking-normal leading-loose text-gray-600">
                <div className="flex gap-1.5 items-center">
                    <img loading="lazy"
                        ...
                        alt="" className="object-contain shrink-0 self-stretch my-auto w-5 aspect-square" />
                    <span className="self-stretch my-auto">1 curso</span>
                </div>
                <div className="flex gap-1.5 items-center">
                    <img loading="lazy"
                        ...
                        alt="" className="object-contain shrink-0 self-stretch my-auto w-5 aspect-square" />
                    <span className="self-stretch my-auto">80.00 PEN</span>
                </div>
                <div className="flex gap-1.5 items-center">
                    <img loading="lazy"
                        ...
                        alt="" className="object-contain shrink-0 self-stretch my-auto w-5 aspect-square" />
                    <span className="self-stretch my-auto">Tarjeta crédito ...0987</span>
                </div>
            </div>
        </div>
        <button className="flex gap-4 items-center self-stretch p-3 my-auto w-12 h-12 bg-red-100 rounded-lg"
    ...
    <div className="animate-flip-down flex flex-col w-full border border-red-100 border-solid max-md:max-w-full">
        <div
            className="flex flex-wrap gap-10 justify-between items-center px-6 pt-6 pb-4 w-full bg-white max-md:px-5 max-md:max-w-full">
            <div className="flex flex-col self-stretch my-auto min-w-[240px]">
                <time datetime="2024-04-01T11:30:00"
                    className="text-lg font-medium tracking-tight leading-none text-rose-700">
                    1 Abril, 2024 - 11:30 AM
                </time>
                <div className="flex gap-4 items-start mt-3 text-sm tracking-normal leading-loose text-gray-600">
                    <div className="flex gap-1.5 items-center">
                        <img loading="lazy"
                            ...
                            alt="" className="object-contain shrink-0 self-stretch my-auto w-5 aspect-square" />
                        <span className="self-stretch my-auto">2 curso</span>
                    </div>
                    <div className="flex gap-1.5 items-center">
                        <img loading="lazy"
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/f49a26d2d84c5172a3a54bdff056004adcfdd9d626c1ebeb360733e25833c2a4?placeholderIfAbsent=true&apiKey=5531072f5ff9482693929f17ec98446f"
                            alt="" className="object-contain shrink-0 self-stretch my-auto w-5 aspect-square" />
                        <span className="self-stretch my-auto">160.00 PEN</span>
                    </div>
                    <div className="flex gap-1.5 items-center">
                        <img loading="lazy"
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/54cc33ba0bb9adce2cd62a8d341522a4660734c8751ee4528916a6d8588d0dea?placeholderIfAbsent=true&apiKey=5531072f5ff9482693929f17ec98446f"
            ...
            <button className="flex gap-4 items-center self-stretch p-3 my-auto w-12 h-12 bg-rose-700 rounded-lg"
                aria-label="Action button">
                <img loading="lazy"
        ...
        <div className="flex flex-wrap gap-6 px-6 w-full bg-white max-md:px-5 max-md:max-w-full">
            <section className="flex flex-col py-6 my-auto min-w-[240px] w-[594px] max-md:max-w-full">
                <div className="flex flex-wrap gap-10 justify-center items-center w-full max-md:max-w-full">
                    <div className="flex gap-5 items-start self-stretch my-auto min-w-[240px] max-md:max-w-full">
                        <img loading="lazy"
                            ...
                            alt="Course thumbnail" className="object-contain shrink-0 aspect-square w-[120px]" />
                        <div className="flex flex-col justify-between min-h-[119px] min-w-[240px] w-[312px]">
                            <div className="flex flex-col w-full max-w-[312px]">
                                <div
                                    className="flex gap-1.5 justify-center items-center self-start text-sm tracking-normal">
                                    <img loading="lazy"
                                    ...
                                    <div className="flex items-center self-stretch my-auto">
                                        <span
                                            className="self-stretch my-auto font-medium leading-none text-gray-600">4.6</span>
                                        <span className="self-stretch my-auto leading-loose text-red-300">(451,444
                                            Reseñas)</span>
                                    </div>
                                </div>
                                <h3 className="mt-2 text-base font-medium leading-6 text-neutral-800">Aliquam venenatis
                            ...
                            <p className="flex gap-1.5 items-start self-start mt-6 text-sm tracking-normal leading-loose">
                                ...
                                <span className="text-gray-600">Ademir Neyra</span>
                            </p>
                        </div>
                    </div>
                    <p className="self-stretch my-auto text-xl font-medium leading-tight text-rose-700">13.99 PEN</p>
                </div>
            ...
            <aside
                className="flex flex-col flex-1 shrink justify-center py-6 pl-6 bg-white border-l border-solid basis-0 border-l-slate-200 border-slate-200 min-w-[240px]">
                <div className="flex flex-col w-full">
                    ...
                    <div
                        className="flex gap-4 items-start self-start mt-3 text-sm tracking-normal leading-loose text-gray-600">
                        <div className="flex gap-1.5 items-center">
                            <img loading="lazy"
                ...
                <div
                    className="flex justify-between items-center mt-6 w-full text-sm tracking-normal leading-loose text-gray-600">
                    <span className="self-stretch my-auto w-[120px]">Carlos Soria</span>
                    <span className="self-stretch my-auto text-lg tracking-tight leading-none text-center w-[238px]">****
                        **** **** 0987</span>
                    <span className="self-stretch my-auto w-20 text-right">04/24</span>
                </div>
            </aside>
        </div>
    </div>
