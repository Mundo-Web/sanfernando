  ...
  return (
    <div className="flex flex-col">
      {isloadingContent && <div role="status" className='text-center mt-4'>
        <svg aria-hidden="true" class="inline w-14 h-14 text-gray-200 animate-spin dark:text-gray-600 fill-[#F19905]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {items.map((item, index) => (
        <div key={index}>
          <div
            ...
            {openIndex === index ? (
              <button
                className="flex gap-4 items-center self-stretch p-3 my-auto w-12 h-12 bg-[#F19905] rounded-lg"
              ...
              <button
                className="flex gap-4 items-center self-stretch p-3 my-auto w-12 h-12 bg-yellow-100 rounded-lg"
                aria-label="Action button">
                <img
                  loading="lazy"
                    ...
                    <div key={index} className="flex flex-wrap gap-10 justify-center items-center w-full max-md:max-w-full">
                      <div className="flex gap-5 items-start self-stretch my-auto min-w-[240px] max-md:max-w-full">
                        ...
                        <div className="flex flex-col justify-between min-h-[119px] min-w-[240px] w-[312px]">
                          ...
                          <div className="flex flex-col items-start self-start mt-6 text-sm tracking-normal leading-loose">
                            <span className="text-[#F19905]">Curso impartido por:</span>
                      ...
                      <p className="self-stretch my-auto text-xl font-medium font-Montserrat_Regular leading-tight text-[#F19905]">
                        S/ {detalle.price}
                      </p>
                    </div>
                  ))}
