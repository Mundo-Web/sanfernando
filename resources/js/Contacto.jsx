...
return (<>
    ...
    <section>
        <div className="flex gap-10 items-start px-[5%] lg:px-[8%] py-12 lg:py-20 bg-rose-50 font-poppins_regular">
            <div className="flex flex-wrap flex-1 shrink gap-10 items-start w-full basis-0 min-w-[240px] max-md:max-w-full">
                <div className="flex flex-col flex-1 shrink basis-12 min-w-[240px] max-md:max-w-full">
                    ...
                    <div className="flex flex-col mt-10 w-full max-md:max-w-full">
                        <div className="grid grid-cols-1 lg:grid-cols-3 items-start w-full">
                            <div className="text-lg font-semibold leading-none text-rose-700 whitespace-nowrap w-[140px] lg:col-span-1">
                                Dirección
                            </div>
                            <div className="flex-1 shrink text-sm tracking-normal leading-5 text-gray-600 basis-0 lg:col-span-2 mt-4 md:mt-0">
                ...
                <div className="flex flex-col p-6 bg-white rounded-xl min-w-[240px] w-[560px] max-md:px-5 max-md:max-w-full">
                    ...
                    <form>
                        <div className="flex flex-wrap gap-4 items-start mt-8 w-full whitespace-nowrap max-md:max-w-full">
                            <div className="flex flex-col flex-1 shrink basis-0 min-w-[240px]">
                                <div className="text-sm tracking-normal leading-loose text-gray-600">
                                    Nombres
                                </div>
                                <div
                                    className="flex-1 shrink gap-2.5 self-stretch px-4 py-3 mt-1.5 w-full text-base leading-tight text-rose-700 bg-rose-50 rounded-xl border border-rose-700 border-solid">
                                    Nombres
                                </div>
                            </div>
                            <div className="flex flex-col flex-1 shrink basis-0 min-w-[240px]">
                                ...
                                <div
                                    className="flex-1 shrink gap-2.5 self-stretch px-4 py-3 mt-1.5 w-full text-base leading-tight text-red-200 bg-rose-50 rounded-xl">
                                    Apellidos
                                </div>
                            </div>
                        </div>
                        <div className="flex gap-4 items-start mt-8 w-full whitespace-nowrap max-md:max-w-full">
                            <div className="flex flex-col flex-1 shrink w-full basis-0 min-w-[240px] max-md:max-w-full">
                                <div className="text-sm tracking-normal leading-loose text-gray-600 max-md:max-w-full">
                                    Email
                                </div>
                                <div
                                    className="flex-1 shrink gap-2.5 self-stretch px-4 py-3 mt-1.5 w-full text-base leading-tight text-red-200 bg-rose-50 rounded-xl max-md:max-w-full">
                                    hola@mail.com
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4 items-start mt-8 w-full whitespace-nowrap max-md:max-w-full">
                            <div className="flex flex-col flex-1 shrink w-full basis-0 min-w-[240px] max-md:max-w-full">
                                ...
                                <div
                                    className="flex-1 shrink gap-2.5 self-stretch px-4 py-3 mt-1.5 w-full text-base leading-5 text-red-200 bg-rose-50 rounded-xl max-md:max-w-full">
                                    Hola...
                                    <br />
                                    <br />
                                    <br />
                        ...
                        <div
                            ...
                            <div className="self-stretch my-auto">Enviar</div>
                            <img loading="lazy"
