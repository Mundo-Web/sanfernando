    ...
    return (<>
        ...
        <section>
            <div
                ...
                <div className=" px-8 py-3 text-sm font-semibold tracking-normal text-white bg-gray-500 rounded-xl">
                    Volver a mi panel
                </div>
            </div>
        </section>
        ...
        <section className='px-[5%] lg:px-[8%]'>
            <div className="flex flex-col py-16 font-semibold max-w-[687px] font-poppins_regular items-center justify-center mx-auto">
                <div className="flex flex-col w-full text-center max-md:max-w-full ">
                    ...
                    <div className="flex flex-col items-center mt-4 w-full max-md:max-w-full">
                        ...
                        <div className="mt-4 text-xl tracking-normal leading-7 text-neutral-800 max-md:max-w-full">
                            Has finalizado tu examen en Gestión Pública. Revisa tus resultados,
