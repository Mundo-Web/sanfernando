...
const Home = ({
  ...
  return (<>
    ...
    <section className="flex flex-wrap items-center">
      <div className="flex flex-1 shrink self-stretch my-auto h-3 bg-orange-400 basis-0 min-w-[240px] w-1/2"></div>
      <div className="flex flex-1 shrink self-stretch my-auto h-3 bg-cyan-600 basis-0 min-w-[240px] w-1/2"></div>
    </section>
