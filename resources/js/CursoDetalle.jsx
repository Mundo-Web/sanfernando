    ...
    <main className="z-[15] !font-poppins_regular">
        ...
        <div className="flex flex-col lg:flex-row gap-10 justify-between items-start px-[5%] lg:px-[8%] mt-16">
            <div className="flex flex-col min-w-[240px] w-full max-w-4xl">
                ...
                <div className="flex flex-col p-6 mt-10 w-full bg-rose-50 rounded-2xl max-md:px-5 max-md:max-w-full">
                ...
                <div className="flex flex-col p-8 mt-10 w-full bg-red-100 rounded-2xl max-md:px-5 max-md:max-w-full">
                    ...
                    <div
                        className="flex flex-col mt-6 w-full text-base font-medium leading-7 text-gray-600 max-md:max-w-full">
                ...
                <div className="flex flex-col mt-10 w-full max-md:max-w-full">
                    ...
                    <div className="mt-6 text-base font-medium leading-7 text-gray-600 max-md:max-w-full">
                ...
                <div className="flex flex-col mt-10 w-full max-md:max-w-full">
                    ...
                    <div
                        ...
                        <div
                            className="flex gap-2.5 justify-center items-center self-start px-5 py-2.5 mt-6 text-sm font-bold text-center text-white bg-rose-700 min-h-[40px] rounded-[100px]">
                    ...
                    <div className="flex flex-col mt-4 text-sm tracking-normal leading-loose text-gray-600">
                        <div className="flex gap-3 items-center">
                            <img loading="lazy"
                                ...
                                className="object-contain shrink-0 self-stretch my-auto w-6 aspect-square" />
                            <div className="self-stretch my-auto w-[340px]">Acceso de por vida</div>
                        </div>
                        <div className="flex gap-3 items-center mt-3">
                            <img loading="lazy"
                                ...
                                className="object-contain shrink-0 self-stretch my-auto w-6 aspect-square" />
                            <div className="self-stretch my-auto w-[340px]">
                                Garantía de devolución de dinero de 30 días
                            </div>
                        </div>
                        <div className="flex gap-3 items-center mt-3 leading-6">
                            <img loading="lazy"
                        ...
                        <div className="flex gap-3 items-center mt-3">
                            <img loading="lazy"
                                ...
                                className="object-contain shrink-0 self-stretch my-auto w-6 aspect-square" />
                            <div className="self-stretch my-auto w-[340px]">Curso 100% en línea</div>
                        </div>
                    </div>
                </div>
                <div className="mt-6 w-full border border-white border-solid min-h-[1px]"></div>
